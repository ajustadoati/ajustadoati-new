 ...
 */
@EnableJpaRepositories(basePackages = "com.ajustadoati.categoryservice.repositories")
@EnableTransactionManagement
@Profile("test")
public class H2JpaConfig {

    // @Entity annotated classes
    private final String[] entityPackages = {"com.ajustadoati.categoryservice.models"};
